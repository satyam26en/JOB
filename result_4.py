...
# Define the y-axis tick values based on the selected experience level
yaxis_tickvals = {
    'All': [0, 500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500],
    'Fresher': [0, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000],
    'Junior': [0, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000],
    'Mid-Level': [0, 200, 400, 600, 800, 1000, 1200, 1400, 1600, 1800, 2000],
    'Senior': [0, 200, 400, 600, 800, 1000, 1200, 1400, 1600, 1800, 2000],
    'Expert': [0, 50, 100, 150, 200, 250, 300, 350, 400, 450, 500]
}
...
fig.update_layout(
    ...
    yaxis=dict(
        tickmode='array',
        tickvals=yaxis_tickvals.get(experience_level, yaxis_tickvals['All']),
